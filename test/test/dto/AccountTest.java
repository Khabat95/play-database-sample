...
public class AccountTest extends AbstractTest {
	...
	public void dtoConversion() {
		...
		// Different email
		account = new Account("sdubois86@gmail.com", "sdubois86@gmail.com", "sdubois87", "sdubois87");
		assertNotEquals(account, Account.fromDbUser(dbUser));
		assertNotEquals(dbUser, account.toDbUser());
		// Different password
		account = new Account("sdubois87@gmail.com", "sdubois87@gmail.com", "sdubois86", "sdubois86");
		assertNotEquals(account, Account.fromDbUser(dbUser));
		assertNotEquals(dbUser, account.toDbUser());
		// Different email and password
		account = new Account("sdubois86@gmail.com", "sdubois86@gmail.com", "sdubois86", "sdubois86");
		assertNotEquals(account, Account.fromDbUser(dbUser));
		assertNotEquals(dbUser, account.toDbUser());
	}
